...
!!! Diese Seite zeigt ein Beispiel für eine **Standardseite**. Dies ist der einfachste Seitentyp und wird für einfache Seitenlayouts verwendet, mit den Standardkomponenten. Folgende Funktionen sind in diesem Beispiel enthalten:  
